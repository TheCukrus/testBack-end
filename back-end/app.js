...
git init
git config --local user.name "Jevgenij"
git config --local user.email "sssgustavsss@gmail.com"
git config --local push.default current
echo node_modules/>.gitignore
git remote add origin https://github.com/TheCukrus/testBack-end.git
git remote -v
